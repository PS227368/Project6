...
<head>
    ...
    <!-- Make sure Tailwind CSS is loaded after other stylesheets -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.css">
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">

    <!-- Remove the external navbar and index stylesheets -->
            ...
            @foreach($products as $product)
                <a href="{{ url('/product/'.$product->id) }}" class="product-link">
                    <div class="product-item bg-white rounded-lg shadow-lg p-4">
                        ...
                        <h3 class="text-xl font-bold my-2 text-green-500 hover:text-dark-green-500 no-underline">{{ $product->name }}</h3>
